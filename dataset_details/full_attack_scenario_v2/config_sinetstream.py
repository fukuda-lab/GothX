...
PROJECT_NAME = "gothX_fullDataset_240724_1432"
...
# nodes_with_ssh: list[tuple[str, str, str]] = [("iotsim-domotic-monitor-bis-1", "admin", "12345")]
...
w_time_legitimate_only_before_attack = 60 * 60 * 3
w_time_cve_exploitation_openrevshell = 60 * 30
w_time_openrevshell_toolstransfert = 60 * 30
w_time_toolstransfert_nmap = 60 * 60
w_time_nmap_hydra = 60 * 45
w_time_hydra_mqttsa_scp = 60 * 19
w_time_scp_coordinated_launch = 60 * 32
w_time_end_ddos_to_end_scenario = 60 * 30
...
mqttsa_args = "-fc 100 -fcsize 10 -sc 4800"
