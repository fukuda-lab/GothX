...
all: buildstatus/DNS buildstatus/certificates buildstatus/NTP \
     ...
     buildstatus/scanner buildstatus/amplification_coap buildstatus/mqtt_attacks buildstatus/mqtt_malaria buildstatus/metasploit \
...
buildstatus/amplification_coap: Dockerfiles/malware/amplification_coap/Dockerfile
...
buildstatus/mqtt_malaria: Dockerfiles/malware/mqtt_malaria/Dockerfile
	$(BUILD_CMD) --file $< --tag iotsim/mqtt-malaria Dockerfiles/malware/mqtt_malaria
...
buildstatus/domotic_monitor: Dockerfiles/iot/domotic_monitor/Dockerfile Dockerfiles/iot/domotic_monitor/client_bis.py Dockerfiles/iot/domotic_monitor/sml2010/*.txt.xz buildstatus/certificates
	$(BUILD_CMD) --file $< --tag iotsim/domotic-monitor-bis Dockerfiles/iot/domotic_monitor
	@touch $@
...
# nodes involved in sinetstream scenario (mqtt-connect-kafka)
buildstatus/zookeper: Dockerfiles/mqtt-connect-kafka/kafka_zookeeper/Dockerfile
	$(BUILD_CMD) --file $< --tag sinetstream-zookeeper Dockerfiles/mqtt-connect-kafka/kafka_zookeeper/
	@touch $@

buildstatus/kafka_broker: Dockerfiles/mqtt-connect-kafka/kafka_broker/Dockerfile
	$(BUILD_CMD) --file $< --tag sinetstream-kafka-broker Dockerfiles/mqtt-connect-kafka/kafka_broker
	@touch $@

buildstatus/connect_to_kafka: Dockerfiles/mqtt-connect-kafka/connect_to_kafka/Dockerfile
	$(BUILD_CMD) --file $< --tag sinetstream-connect-kafka Dockerfiles/mqtt-connect-kafka/connect_to_kafka
	@touch $@
